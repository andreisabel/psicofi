...
<body>
    <div style="background-color: #004A98; color:white; font-size: x-large; font-weight: bold; font-family: Arial, Helvetica, sans-serif; padding: 20px 0px 0px 0px">
        ...
        <div style="background-color:#00B2E3; height:10px; margin-top:20px">
        </div>
    </div>
    <div id="content" style="background-color: #fafafa; padding: 30px; font-size: x-medium; font-family: Arial, Helvetica, sans-serif;">
        ...
        <p>Tu cita con el psicólogo <b>{{ $details['psicologo'] }}</b> ha sido agendada correctamente para el día {{ $details['fecha'] }} a las {{ $details['hora'] }}.</p>
        <p>Recuerda que sólo puedes cancelar tu cita con 2 días de anticipación.</p>
